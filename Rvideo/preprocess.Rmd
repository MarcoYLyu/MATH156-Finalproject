...
- Train the model with 30% of the data, test with 70% of the data
...
- Result: MSE = $\frac{1}{n}\sum(Y_{test} - Y_{pred})^2$ = 0.04845363274216652
...
42/42 [==============================] - 0s 593us/step - loss: 0.0485
test loss, test acc: 0.04845363274216652
Model: "sequential"
